...
| **[Anzen](./packages/anzen)**                                                       | [![version](https://img.shields.io/npm/v/@daisugi/anzen.svg)](https://www.npmjs.com/package/@daisugi/anzen)       | [View](./packages/anzen/CHANGELOG.md)    | A `Result` type for safe error handling without exceptions, inspired by Rust and Haskell. |
