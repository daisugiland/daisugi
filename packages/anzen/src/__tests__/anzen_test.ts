...
import { Result, ResultFailure, ResultSuccess } from '../anzen.js';
      ...
      () => {
        it(
          ...
          () => {
            ...
            assert.equal(result.chain((x) => x + 1), 2);
            assert.equal(
      ...
      () => {
        it(
          ...
          () => {
            ...
            assert.equal(result.elseChain((x) => x + 1), 2);
            assert.equal(
      ...
      () => {
        it(
          ...
          () => {
            ...
            assert.equal(result.getValue(), 1);
            assert.equal(
              result instanceof ResultSuccess,
              true,
            );
            result =
              Result.fromJSON(
            ...
            assert.equal(result.getError(), 1);
            assert.equal(
              result instanceof ResultFailure,
              true,
            );
          },
        );
